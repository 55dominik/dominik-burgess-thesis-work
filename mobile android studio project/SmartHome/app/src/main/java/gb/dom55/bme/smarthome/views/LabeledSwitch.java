package gb.dom55.bme.smarthome.views;
...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initView() {
        ...
        this.enabled = true;
        this.textSize = (int)(20f * getResources().getDisplayMetrics().scaledDensity);


        colorBorder = colorOn = R.color.colorAccent;
